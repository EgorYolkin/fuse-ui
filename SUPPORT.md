...
Please provide the package, React, browser, and Node.js versions that are relevant to the problem, plus a minimal reproduction. Support is best-effort and has no guaranteed response time.
